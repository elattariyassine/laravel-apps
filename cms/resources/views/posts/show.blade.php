      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            <h1 class="mb-3 bread" style="font-size: 6rem;">{{$post->title}}</h1>
        ...
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            ...
            <div class="about-author d-flex p-4 bg-light">
              <div class="bio mr-5">
                <img src="{{ $post->user->hasPicture() ? asset('storage/'.$post->user->getPicture()) : $user->getGravatar()}}" alt="Image placeholder" class="img-fluid mb-4">
              </div>
              <div class="desc">
          ...
          <div class="col-lg-4 sidebar pl-lg-5 ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              <div class="categories">
                ...
                @empty
                    <li><a href="#">No categories yet<span class="ion-ios-arrow-forward"></span></a></li>
                @endforelse
              </div>
            </div>
